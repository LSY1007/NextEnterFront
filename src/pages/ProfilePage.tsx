        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            {onBack && (
              <button
                onClick={onBack}
                className="p-2 text-gray-600 transition hover:text-gray-900"
              >
                <svg
                  className="w-6 h-6"
                  fill="none"
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="relative">
              ...
              {/* ✅ 수정 모드일 때만 이미지 업로드 버튼 활성화 */}
              {isEditing && (
                <button
                  onClick={() => fileInputRef.current?.click()}
                  disabled={isLoading}
                  className="absolute bottom-0 right-0 p-2 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition disabled:opacity-50"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 disabled:bg-gray-100 resize-none"
              />
            </div>
